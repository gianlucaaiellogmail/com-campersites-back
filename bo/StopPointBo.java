...
public class StopPointBo implements Serializable {
	...
	public String toString() {
		return "StopPointBo [stopId=" + stopId + ", latitude=" + latitude + ", longitude=" + longitude
				+ ", latitudeDeg=" + latitudeDeg + ", longitudeDeg=" + longitudeDeg + ", description=" + description
				+ ", modified=" + modified + ", modifiedByUser=" + modifiedByUser + ", typeId=" + typeId
				+ ", totPreferito=" + totPreferito + ", rating=" + rating + ", fotoPath=" + fotoPath + ", homepage="
				+ homepage + ", valuta=" + valuta + ", prezzoNotturno=" + prezzoNotturno + ", prezzoOrario="
				+ prezzoOrario + ", prezzoGiornaliero=" + prezzoGiornaliero + ", prezzoSettimanale=" + prezzoSettimanale
				...
				+ fermata + ", wifi=" + wifi + ", locality=" + locality + ", nation=" + nation + ", reviews=" + reviews
				+ ", telefono=" + telefono + ", posti=" + posti + ", maxHH=" + maxHH + ", chiusura=" + chiusura
				+ ", preferito=" + preferito + ", howRated=" + howRated + "]";
	}
